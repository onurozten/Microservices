...
{
    public class TokenExcenhangeExtensionGrantValidator : IExtensionGrantValidator
    {
        private readonly ITokenValidator _tokenValidator;

        public string GrantType => "urn:ietf:params:oauth:grant-type:token-exchange";

        public TokenExcenhangeExtensionGrantValidator(ITokenValidator tokenValidator)
        {
